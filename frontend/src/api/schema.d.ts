...
export interface paths {
    ...
    "/essays": {
        ...
        /** List Essays */
        get: operations["list_essays_essays_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/essays/{essay_id}": {
        ...
        /** Get Essay */
        get: operations["get_essay_essays__essay_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/me/essays/recommended": {
        ...
        /** Recommended Essays */
        get: operations["recommended_essays_me_essays_recommended_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        Essay: {
             ...
             * @enum {string}
             */
            level: "bachelor" | "master" | "phd" | "mba" | "other";
            /**
             * Kind
             * @enum {string}
             */
            kind: "common_app" | "personal_statement" | "statement_of_purpose" | "other";
            /** Prompt */
            prompt?: string | null;
            /** Program */
            program: string | null;
             ...
             * @enum {string}
             */
            license: "CC_BY_NC_SA_4_0" | "UNKNOWN";
            /** Source Url */
            source_url: string;
            /** Original Url */
        ...
        /** RecommendedEssay */
        RecommendedEssay: {
            essay: components["schemas"]["EssaySummary"];
            /** Reasons */
            reasons: string[];
        };
        /** Roadmap */
...
export interface operations {
    ...
    list_essays_essays_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["EssaySummary"][];
                };
            };
        };
    };
    get_essay_essays__essay_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    recommended_essays_me_essays_recommended_get: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RecommendedEssay"][];
                };
            };
            /** @description Validation Error */
            422: {
