...
export type AchievementCreated = S["AchievementCreated"];
...
export type StepIn = S["StepIn"];
export type StepPatch = S["StepPatch"];
export type StepKind = RoadmapStep["kind"];
export type MentorMessage = S["MentorMessage"];
export type MentorAction = S["MentorAction"];
export type MentorReply = S["MentorReply"];
...
export type EssaySummary = S["EssaySummary"];
export type Essay = S["Essay"];
export type RecommendedEssay = S["RecommendedEssay"];
export type EssayLevel = EssaySummary["level"];
export type EssayKind = EssaySummary["kind"];
